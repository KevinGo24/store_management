...
- `main.js` - Configuración principal y router
...
2. Ejecuta el servidor de desarrollo:
   ...
   npm run dev
   ```
3. Abre el proyecto en tu navegador en la dirección que indique Vite, por ejemplo `http://localhost:5173`.
